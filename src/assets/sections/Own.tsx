...
const Own = () => {
    return (
        <div className="container mt-20 mb-10">
            <div className="p-5 grid gap-10 lg:gap-5 justify-center lg:grid-cols-3 rounded-md bg-gradient-to-l from-blue-400 to-blue-700 text-white">
                ...
                <div className="p-0 md:px-20 lg:p-0">
